    ...
    <div class="container-fluid">
            ...
            <div class="prs_menu_main_wrapper">
                <nav class="navbar navbar-default">
                    <div id="dl-menu" class="xv-menuwrapper responsive-menu">
                        ...
                        <ul class="dl-menu">
                            <li class="parent"><a href="{{ route('movies.index') }}">Trang chủ</a>

                            </li>
                            <li class="parent megamenu"><a href="{{ route('category.index') }}">Phim </a>
                                {{-- <ul class="lg-submenu">
                            ...
                            <li class="parent"><a href="{{ route('contact.index') }}">Liên hệ</a>
                            </li>
                            <li class="parent"><a href="{{ route('vouchers.index') }}">Mã giảm giá </a>

                        @if (Auth::check())
                            <li class="parent logout-btn">
                                <a href="javascript:void(0)"
                                    onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                                    class="button button--tamaya" data-text="Đăng xuất">
                                    <span>Đăng xuất </span>
                                </a>
                            </li>
                        @else
                            <li class="login-btn">
                                <a href="{{ route('getLogin') }}" class="button button--tamaya" data-text="Đăng nhập">
                                    <span>Đăng nhập </span>
                                </a>
                            </li>
                    ...
                    <ul>
                        @if (Auth::check())
                            <form action="{{ route('logout') }}" method="POST" id="logout-form">
                                @csrf
                                <li>
                                    <button class="button button--tamaya" type="submit" data-text="Đăng xuất">
                                        <span>Đăng xuất </span>
                                    </button>
                                </li>
                            </form>
                        @else
                            <li><a href="{{ route('getLogin') }}" class="button button--tamaya"
                                    data-text="Đăng nhập"><span>Đăng nhập </span></a>
                            </li>
                        @endif
        ...
        C37.652,36.448,45.953,40,45.953,40l1.043-8.658C41.41,30.454,38.125,32.244,35.314,34.585z" />
                ...
                <ul class="mobile-list-nav">
                    <li><a href="{{ route('userOverview') }}">THÔNG TIN NGƯỜI DÙNG </a>
                    </li>
                    <li><a href="{{ route('ticketHistory') }}">VÉ ĐÃ ĐẶT </a>
                    </li>
...
<!-- prs navigation End -->
<style>
    /* Mặc định: Ẩn nút "Sign in" trên máy tính */
    /* Mặc định: Ẩn nút "Sign in" trên máy tính */
    .login-btn {
        display: none !important;
    }

    /* Hiển thị nút "Sign in" trên di động */
    ...
    /* Mặc định: Hiển thị nút "Log out" trên máy tính */
    .logout-btn {
        display: none !important;
    }

    /* Ẩn nút "Log out" trên di động */
    @media (max-width: 767px) {
        .logout-btn {
            display: block !important;
        }
