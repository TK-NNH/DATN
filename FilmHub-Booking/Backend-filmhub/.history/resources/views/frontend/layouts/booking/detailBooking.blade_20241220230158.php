                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="st_cherity_btn float_left">
                                        <h3 style="color: red">Vui lòng hoàn thành trước thời gian bắt đầu ca chiếu  {{ \Carbon\Carbon::parse($showtime->shifts->start_time)->format('H:i') }} - {{ \Carbon\Carbon::parse($showtime->datetime)->format('H:i') }} , nếu vượt quá sẽ ko thể hoàn thành mua vé ! </h3>
                                        <ul>
