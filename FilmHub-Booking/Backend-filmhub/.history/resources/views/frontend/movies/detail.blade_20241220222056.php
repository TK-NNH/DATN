...
{{-- <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet"> --}}
    ...
    <div class="prs_ms_trailer_vid_main_wrapper ">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-lg-12 col-lg-12 col-lg-12 d-flex justify-content-center flex-wrap">
                    <div class="item">
                    ...
                    <div class="prs_ms_trailer_slider_right_wrapper">
                        ...
                        <h5 class="performer"><span>Diễn viên  -</span> {{ $movie->performer }}
                        </h5>
                        <ul>
                            <li>Thời lượng  - <span>{{ $movie->duration }} Phút</span>
                            </li>
                            <li>Đạo diễn  - <span>{{ $movie->director }}</span>
                            </li>
                        </ul>
                        <!-- Phần đánh giá sao -->
                                            ...
                                            <div class="prs_upcom_movie_img_box">
                                                ...
                                                <div class="prs_upcom_movie_img_btn_wrapper">
                                                    <ul>
                                                        <li>
                                                            <a href="#"
                                                                onclick="openTrailerModal('{{ $mv->trailer }}')">Xem trailer</a>
                                                        </li>
                                                        <li><a href="{{ route('movies.detail', $mv->movie_id) }}">Xem chi tiết</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
