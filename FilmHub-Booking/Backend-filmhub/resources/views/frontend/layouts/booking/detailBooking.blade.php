                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                        <div class="st_bt_top_back_btn float_left">
                            <a href="{{route('getSeatBooking',$showtime->showtime_id)}}"><i class="fas fa-long-arrow-alt-left"></i> &nbsp;Back</a>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="st_cherity_btn float_left">
                                        <h3 style="color: red">Vui lòng hoàn thành trước thời gian bắt đầu ca chiếu  {{ \Carbon\Carbon::parse($showtime->shifts->start_time)->format('H:i') }} - {{ \Carbon\Carbon::parse($showtime->datetime)->format('d/m/Y') }} , nếu vượt quá sẽ ko thể hoàn thành mua vé ! </h3>
                                        <ul>
                                            {{-- <li><a href="#"><i class="flaticon-tickets"></i> &nbsp;M-Ticket</a></li>
                                            <li><a href="#"><i class="flaticon-tickets"></i> &nbsp;Box office
                                                    Pickup</a></li> --}}
                                            <li><button type="submit" class="btn btn-success" onclick="startPayment()">Thanh toán</button></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
function startPayment() {
        ...
        Swal.fire({
            ...
            text: "Bạn có tối đa 5 phút để hoàn thành thanh toán , nếu quá thời gian sẽ tự động hủy vé . Nếu hủy quá 3 lần thì sẽ cầm đặt vé . Bạn chắc chắn muốn tiếp tục thanh toán?",
            icon: 'warning',
